...
SOLUTION_CONFIG = AttrDict({
    ...
    'glove_dpcnn_network': {
        'architecture_config': {'model_params': {'max_features': neptune_context.params.max_features_word,
                                                 ...
                                                 'trainable_embedding': bool(
                                                     neptune_context.params.trainable_embedding),
                                                 'filter_nr': neptune_context.params.filter_nr,
                                                 'kernel_size': neptune_context.params.kernel_size,
                                                 'repeat_block': neptune_context.params.repeat_block,
                                                 'dense_size': neptune_context.params.dense_size,
                                                 'repeat_dense': neptune_context.params.repeat_dense,
                                                 'l2_reg': neptune_context.params.l2_reg_convo,
                                                 'use_prelu': bool(neptune_context.params.use_prelu),
                                                 'use_batch_norm': bool(neptune_context.params.use_batch_norm),
    ...
    'glove_lstm_network': {
        'architecture_config': {'model_params': {'max_features': neptune_context.params.max_features_word,
                                                 ...
                                                 'trainable_embedding': bool(
                                                     neptune_context.params.trainable_embedding),
                                                 'unit_nr': neptune_context.params.filter_nr,
                                                 'repeat_block': neptune_context.params.repeat_block,
                                                 'global_pooling': bool(neptune_context.params.global_pooling),
                                                 'dense_size': neptune_context.params.dense_size,
                                                 'repeat_dense': neptune_context.params.repeat_dense,
                                                 'l2_reg': neptune_context.params.l2_reg_convo,
                                                 'use_prelu': bool(neptune_context.params.use_prelu),
