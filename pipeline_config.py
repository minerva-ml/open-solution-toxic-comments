...
SOLUTION_CONFIG = AttrDict({
    ...
    'glove_dpcnn_network': {
        'architecture_config': {'model_params': {'max_features': neptune_config.parameters.max_features_word,
                                                 ...
                                                 'dropout_covo': neptune_config.parameters.dropout_convo,
    ...
    'char_cnn_network': {'architecture_config': {'model_params': {'max_features': neptune_config.parameters.max_features_char,
                                                 'maxlen': neptune_config.parameters.maxlen_char,
